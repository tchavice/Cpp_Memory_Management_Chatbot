...
private:
    ...
    //ChatLogic *_chatLogic; original
    // Task 1: make ChatLogic an exlusive resource
...
public:
    ...
    // getter / setter
    //Task 1: update getter method for unique pointer
    //Copy constructor of a unique ptr is deleted, so use get method
